  ...
  <body class="relative font-sans text-black">
    <div id="app" data-server-rendered="true" data-v-app>
      <header data-v-14f5f3d7 class="header z-40">
        <a
          data-v-14f5f3d7 aria-current="page" href="/"
          class="router-link-exact-active absolute m-5 h-12 w-12 select-none outline-none xl:fixed" focusable="false"
        >
          <svg data-v-6bb35677="" data-v-14f5f3d7="" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            <title data-v-6bb35677="">Anthony Fu @ antfu.me</title>
            <mask
              id="mask0_634_3" data-v-6bb35677="" maskUnits="userSpaceOnUse" x="24" y="7" width="50" height="87"
            ...
            <g data-v-6bb35677="" mask="url(#mask0_634_3)">
              <path
                data-v-6bb35677="" class="path1"
