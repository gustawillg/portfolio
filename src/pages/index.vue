<template>
  <body class="relative font-sans text-black">
    <div id="app" data-server-rendered="true" data-v-app>
          ...
          <div class="mx-auto max-w-7xl px-2 lg:px-8 sm:px-6">
            <div class="relative h-16 flex items-center justify-between">
              <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
                <!-- Mobile menu button -->
                <button type="button" class="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-inset" aria-controls="mobile-menu" aria-expanded="false">
          ...
          -->
              ...
              <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <div class="relative ml-3">
                  <div>
                    <button id="user-menu-button" type="button" class="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white focus:ring-offset-gray-800" aria-expanded="false" aria-haspopup="true">
                      <span class="absolute -inset-1.5" />
      ...
      <main class="of-x-hidden px-7 py-10">
        <div
          ...
          style="z-index:-1; -webkit-mask-image: radial-gradient(circle, transparent, black)"
        >
          <canvas width="1920" height="983" style="width: 1920px; height: 983px;" />
        </div>
        <div class="m-auto mb-8 prose">
